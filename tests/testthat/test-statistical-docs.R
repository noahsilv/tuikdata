test_that("statistical docs describe the rewritten JSON and SDMX interface", {
  ...
  expect_true(any(grepl("articles/getting-started.html", readme_rmd_lines, fixed = TRUE)))
  expect_true(any(grepl("articles/geographic-mapping.html", readme_rmd_lines, fixed = TRUE)))
  ...
  expect_true(any(grepl("articles/getting-started.html", readme_md_lines, fixed = TRUE)))
  expect_true(any(grepl("articles/geographic-mapping.html", readme_md_lines, fixed = TRUE)))
