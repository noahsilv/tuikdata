...
default `key = "ALL"`, while others need a more specific SDMX key. When you
want the TUIK browser's default pivoted table instead of long-form
observations, use `layout = "table"`.
