...
Use `statistical_data_structure()` when you need metadata about dimensions and
codes, then use `statistical_data()` to download observations. Some datasets
work with the default `key = "ALL"`, while others need a more specific SDMX
key built from the structure metadata.
