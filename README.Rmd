...
The SDMX layer will be exposed through `statistical_data_structure()` for
metadata and `statistical_data()` for downloads. Both functions will use
`dataflow_id` values returned by `statistical_tables()`.
